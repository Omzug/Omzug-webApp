...
const LOAD_FAIL = 'omzug/submit/LOAD_FAIL';
const EDIT_START = 'omzug/submit/EDIT_START';
const EDIT_STOP = 'omzug/submit/EDIT_STOP';
const SAVE = 'omzug/submit/SAVE';
const SAVE_SUCCESS = 'omzug/submit/SAVE_SUCCESS';
const SAVE_FAIL = 'omzug/submit/SAVE_FAIL';
