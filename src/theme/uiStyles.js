...
export default {
  ...
  snackBarRegisterStyle : {backgroundColor : "#FF6F6F", width:"20px", textAlign:"center", borderRadius:"20px",marginBottom:"30px"},
  snackBarStyle : {backgroundColor : "#6CC9D5", width:"30px", textAlign:"center", borderRadius:"20px",marginBottom:"60px"},
